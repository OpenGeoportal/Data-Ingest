...
/**
 * Created by joana on 13/03/17.
 */
public class GeoServerUtilsTest {

    /**
     * Mockup workspace and dataset names: inspire by docker container names :-) .
     */
    ...
    static String[] datasets = {
        // Muhammad ibn Jābir al-Ḥarrānī al-Battānī was a founding father of astronomy. https://en.wikipedia
        // .org/wiki/Mu%E1%B8%A5ammad_ibn_J%C4%81bir_al-%E1%B8%A4arr%C4%81n%C4%AB_al-Batt%C4%81n%C4%AB
        "albattani",
        ...
        // June Almeida - Scottish virologist who took the first pictures of the rubella virus - https://en.wikipedia
        // .org/wiki/June_Almeida
        "almeida",
        ...
        // Maria Ardinghelli - Italian translator, mathematician and physicist - https://en.wikipedia
        // .org/wiki/Maria_Ardinghelli
        "ardinghelli",
        ...
        // Charles Babbage invented the concept of a programmable computer. https://en.wikipedia
        // .org/wiki/Charles_Babbage.
        "babbage",

        // Stefan Banach - Polish mathematician, was one of the founders of modern functional analysis. https://en
        // .wikipedia.org/wiki/Stefan_Banach
        "banach",
        ...
        // Hugh Beaver, British engineer, founder of the Guinness Book of World Records https://en.wikipedia
        // .org/wiki/Hugh_Beaver
        "beaver",
        ...
        // Karl Friedrich Benz - a German automobile engineer. Inventor of the first practical motorcar. https://en
        // .wikipedia.org/wiki/Karl_Benz
        "benz",

        // Homi J Bhabha - was an Indian nuclear physicist, founding director, and professor of physics at the Tata
        // Institute of Fundamental Research. Colloquially known as "father of Indian nuclear programme"- https://en
        // .wikipedia.org/wiki/Homi_J._Bhabha
        "bhabha",
        ...
        // Elizabeth Blackwell - American doctor and first American woman to receive a medical degree - https://en
        // .wikipedia.org/wiki/Elizabeth_Blackwell
        "blackwell",

        // Niels Bohr is the father of quantum theory. https://en.wikipedia.org/wiki/Niels_Bohr.
        "bohr",

        // Kathleen Booth, she's credited with writing the first assembly language. https://en.wikipedia
        // .org/wiki/Kathleen_Booth
        "booth",
        ...
        // are credited with advancing the global environmental movement. https://en.wikipedia.org/wiki/Rachel_Carson
        "carson",

        // Subrahmanyan Chandrasekhar - Astrophysicist known for his mathematical theory on different stages and
        // evolution in structures of the stars. He has won nobel prize for physics - https://en.wikipedia
        // .org/wiki/Subrahmanyan_Chandrasekhar
        "chandrasekhar",
        ...
        // Jane Colden - American botanist widely considered the first female American botanist - https://en
        // .wikipedia.org/wiki/Jane_Colden
        "colden",
        ...
        // Edsger Wybe Dijkstra was a Dutch computer scientist and mathematical scientist. https://en.wikipedia
        // .org/wiki/Edsger_W._Dijkstra.
        "dijkstra",
        ...
        // Pierre de Fermat pioneered several aspects of modern mathematics. https://en.wikipedia
        // .org/wiki/Pierre_de_Fermat
        "fermat",

        // Enrico Fermi invented the first nuclear reactor. https://en.wikipedia.org/wiki/Enrico_Fermi.
        "fermi",

        // Richard Feynman was a key contributor to quantum mechanics and particle physics. https://en.wikipedia
        ...
        // programmer, and inventor. https://en.wikipedia.org/wiki/Bill_Gates
        "gates",
        ...
        // Lois Haibt - American computer scientist, part of the team at IBM that developed FORTRAN - https://en
        // .wikipedia.org/wiki/Lois_Haibt
        "haibt",

        // Margaret Hamilton - Director of the Software Engineering Division of the MIT Instrumentation Laboratory,
        // which developed on-board flight software for the Apollo space program. https://en.wikipedia
        ...
        // mechanics. https://en.wikipedia.org/wiki/Grete_Hermann
        "hermann",

        // Jaroslav Heyrovský was the inventor of the polarographic method, father of the electroanalytical method,
        // and recipient of the Nobel Prize in 1959. His main field of work was polarography. https://en.wikipedia
        // .org/wiki/Jaroslav_Heyrovsk%C3%BD
        "heyrovsky",

        // Dorothy Hodgkin was a British biochemist, credited with the development of protein crystallography. She
        // was awarded the Nobel Prize in Chemistry in 1964. https://en.wikipedia.org/wiki/Dorothy_Hodgkin
        "hodgkin",

        // Erna Schneider Hoover revolutionized modern communication by inventing a computerized telephone switching
        // method. https://en.wikipedia.org/wiki/Erna_Schneider_Hoover
        "hoover",
        ...
        // Frances Hugle, she was an American scientist, engineer, and inventor who contributed to the understanding
        // of semiconductors, integrated circuitry, and the unique electrical principles of microscopic materials.
        ...
        // mathematics - https://en.wikipedia.org/wiki/Hypatia
        "hypatia",

        // Yeong-Sil Jang was a Korean scientist and astronomer during the Joseon Dynasty; he invented the first
        // metal printing press and water gauge. https://en.wikipedia.org/wiki/Jang_Yeong-sil
        "jang",
        ...
        // founder of Pixel Qi. https://en.wikipedia.org/wiki/Mary_Lou_Jepsen
        "jepsen",
        ...
        // 1980s, and was an original employee of NeXT, working as the Creative Director. https://en.wikipedia
        // .org/wiki/Susan_Kare
        "kare",
        ...
        // TeX typesetting system. https://en.wikipedia.org/wiki/Donald_Knuth
        "knuth",
        ...
        // for routing traffic on the internet. Died attempting to stop the 9-11 hijackers. https://en.wikipedia
        ...
        // Medicine for discovering transposons. https://en.wikipedia.org/wiki/Barbara_McClintock
        "mcclintock",
        ...
        // Lise Meitner - Austrian/Swedish physicist who was involved in the discovery of nuclear fission. The
        // element meitnerium is named after her - https://en.wikipedia.org/wiki/Lise_Meitner
        "meitner",
        ...
        // Marvin Minsky - Pioneer in Artificial Intelligence, co-founder of the MIT's AI Lab, won the Turing Award
        // in 1969. https://en.wikipedia.org/wiki/Marvin_Minsky
        "minsky",

        // Maryam Mirzakhani - an Iranian mathematician and the first woman to win the Fields Medal. https://en
        // .wikipedia.org/wiki/Maryam_Mirzakhani
        "mirzakhani",
        ...
        // John von Neumann - todays computer architectures are based on the von Neumann architecture. https://en
        ...
        // Robert Noyce invented silicone integrated circuits and gave Silicon Valley its name. - https://en
        // .wikipedia.org/wiki/Robert_Noyce
        "noyce",
        ...
        // Louis Pasteur discovered vaccination, fermentation and pasteurization. https://en.wikipedia
        // .org/wiki/Louis_Pasteur.
        "pasteur",
        ...
        // Rob Pike was a key contributor to Unix, Plan 9, the X graphic system, utf-8, and the Go programming
        // language. https://en.wikipedia.org/wiki/Rob_Pike
        "pike",
        ...
        // the causes of truth and freedom of information by reporting disclosures by whistleblowers such as Edward
        ...
        // geographer, astrologer, and poet of a single epigram in the Greek Anthology - https://en.wikipedia
        // .org/wiki/Ptolemy
        "ptolemy",
        ...
        // mathematical analysis, number theory, infinite series, and continued fractions. - https://en.wikipedia
        ...
        // the youngest American astronaut. https://en.wikipedia.org/wiki/Sally_Ride
        "ride",

        // Rita Levi-Montalcini - Won Nobel Prize in Physiology or Medicine jointly with colleague Stanley Cohen for
        // the discovery of nerve growth factor (https://en.wikipedia.org/wiki/Rita_Levi-Montalcini)
        "montalcini",

        // Dennis Ritchie - co-creator of UNIX and the C programming language. - https://en.wikipedia
        // .org/wiki/Dennis_Ritchie
        "ritchie",
        ...
        // was fundamental in identifying HIV as the cause of AIDS. https://en.wikipedia
        ...
        // Foundation, and the League for Programming Freedom. He also invented the concept of copyleft to protect
        // the ideals of this movement, and enshrined this concept in the widely-used GPL (General Public License)
        ...
        // Tech. https://en.wikipedia.org/wiki/Janese_Swanson
        "swanson",

        // Aaron Swartz was influential in creating RSS, Markdown, Creative Commons, Reddit, and much of the internet
        // as we know it today. He was devoted to freedom of information on the web. https://en.wikiquote
        ...
        // highest honour, the Bharat Ratna, in 1955. On his birthday, 15 September is celebrated as Engineer's Day
        ...
        // research on the genetic control of embryonic development. https://en.wikipedia
        // .org/wiki/Christiane_N%C3%BCsslein-Volhard
        "volhard",
    ...
    static List<String> typeNames = new ArrayList<String>();

    @BeforeClass
    public static void setUp() throws Exception {

        for (int i = 0; i < datasets.length; ++i) {
            typeNames.add(workspaces[i <= datasets.length / 2 ? 0 : 1] + ":" + datasets[i]);
    ...
    public void getTypeName() throws Exception {
        ...
        while (i < typeNames.size()) {
            if (!GeoServerUtils.getTypeName(workspaces[i <= datasets.length / 2 ? 0 : 1], datasets[i]).equals(typeNames
                .get(i)))
                break;
            i++;
        }
        if (i == typeNames.size()) --i;

        assertEquals("Could not generate correctly the typename", typeNames.get(i), GeoServerUtils.getTypeName
            (workspaces[i <= datasets.length / 2 ? 0 : 1], datasets[i]));
    }
    ...
    public void getWorkspace() throws Exception {
        ...
        int i = 0;
        while (i < typeNames.size()) {
            if (!GeoServerUtils.getWorkspace(typeNames.get(i)).equals(workspaces[i <= datasets.length / 2 ? 0 : 1]))
                break;
            i++;
        }
        if (i == typeNames.size()) --i;

        assertEquals("Could not extract workspace from typename '" + typeNames.get(i) + "'", workspaces[i <=
                datasets.length / 2 ? 0 : 1],
            GeoServerUtils
                .getWorkspace(typeNames.get(i)));
    }
    ...
    public void getDataset() throws Exception {
        ...
        int i = 0;
        while (i < typeNames.size()) {
            if (!GeoServerUtils.getDataset(typeNames.get(i)).equals(datasets[i])) break;
            i++;
        }
        if (i == typeNames.size()) --i;

        assertEquals("Could not extract dataset from typename '" + typeNames.get(i) + "'", datasets[i], GeoServerUtils
            .getDataset(typeNames.get(i)));
    }

    @Test
    public void explodeTypeName() throws Exception {

        int i = 0;
        String split[] = {};
        while (i < typeNames.size()) {
            split = GeoServerUtils.explodeTypeName(typeNames.get(i));
            if (!split[0].equals(workspaces[i <= datasets.length / 2 ? 0 : 1]) ||
                !split[1].equals(datasets[i])) {
                break;
            }
            i++;
        }
        ...
        assertTrue("Could not explode string '" + typeNames.get(i) + "' correctly. ", workspaces[i <= datasets
            .length / 2 ? 0 : 1].equals(split[0]) && datasets[i].equals(split[1]));
