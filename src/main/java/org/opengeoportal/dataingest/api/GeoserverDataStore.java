...
public class GeoserverDataStore {
    ...
    public final WFSDataStore createDataStore(final String uri) throws Exception {
        ...
        try {
            ...
            throw new Exception("Could not connect to GeoServer " + "at: " + uri + ". Make sure it is up and "
     ...
     * @throws Exception
     */
    public final HashMap<String, String> getTitlesForDataStore(final WFSDataStore data) throws Exception {
     ...
     * @throws Exception
     */
    public final HashMap<String, String> getLayerTitles(final String uri) throws Exception {
     ...
     * @throws Exception
     */
    public final HashMap<String, String> getLayerTitles(final String uri, final String workspace) throws Exception {
     ...
     * @throws Exception
     */
    public final HashMap<String, String> getLayerInfo(final String uri, final String workspace, final String dataset)
        throws Exception {
