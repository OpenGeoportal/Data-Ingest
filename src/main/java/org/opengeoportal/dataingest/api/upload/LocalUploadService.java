...
public class LocalUploadService {
    ...
    public final void uploadFile(final String workspace, final String dataset,
            final File zipFile, final String strEpsg,  long token, final boolean isUpdate)
        ...
        jmsTemplate.convertAndSend("uploadQueue", new UploadRequest(workspace, dataset, zipFile, strEpsg, token));
